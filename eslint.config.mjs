...
function getEslintAliases() {
  ...
  return [
    ...
    [
      'multiverse+mongo-object-id-pseudo-sort:*',
      './packages/mongo-object-id-pseudo-sort/src/*'
    ],
    ...
    [
      'multiverse+mongo-object-id-pseudo-sort',
      './packages/mongo-object-id-pseudo-sort/src/index.ts'
    ],
    ...
    [
      'rootverse+mongo-object-id-pseudo-sort:*',
      './packages/mongo-object-id-pseudo-sort/*'
    ],
    ...
    [
      'universe+mongo-object-id-pseudo-sort:*',
      './packages/mongo-object-id-pseudo-sort/src/*'
    ],
    ...
    [
      'testverse+mongo-object-id-pseudo-sort:*',
      './packages/mongo-object-id-pseudo-sort/test/*'
    ],
